...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 12, 21, 18, 3, 30, 34127885, time.UTC),
		},
		"/etc": &vfsgen۰DirInfo{
			name:    "etc",
			modTime: time.Date(2019, 3, 8, 22, 3, 20, 671780941, time.UTC),
		},
		"/etc/docker": &vfsgen۰DirInfo{
			name:    "docker",
			modTime: time.Date(2018, 12, 21, 18, 3, 30, 34226110, time.UTC),
		},
		"/etc/docker/daemon.json": &vfsgen۰CompressedFileInfo{
			name:             "daemon.json",
			modTime:          time.Date(2018, 12, 21, 18, 3, 30, 34255752, time.UTC),
		...
		"/etc/nginx": &vfsgen۰DirInfo{
			name:    "nginx",
			modTime: time.Date(2018, 12, 21, 18, 3, 30, 34358544, time.UTC),
		},
		"/etc/nginx/nginx.conf": &vfsgen۰CompressedFileInfo{
			name:             "nginx.conf",
			modTime:          time.Date(2018, 12, 21, 18, 3, 30, 34399902, time.UTC),
		...
		"/etc/sysctl.d": &vfsgen۰DirInfo{
			name:    "sysctl.d",
			modTime: time.Date(2018, 12, 21, 18, 3, 30, 34537246, time.UTC),
		},
		"/etc/sysctl.d/k8s.conf": &vfsgen۰CompressedFileInfo{
			name:             "k8s.conf",
			modTime:          time.Date(2018, 12, 21, 18, 3, 30, 34598972, time.UTC),
			uncompressedSize: 78,
		...
		"/etc/yum.repos.d": &vfsgen۰DirInfo{
			name:    "yum.repos.d",
			modTime: time.Date(2019, 3, 8, 22, 3, 20, 871628700, time.UTC),
		},
		"/etc/yum.repos.d/sds_bootstrap.repo": &vfsgen۰FileInfo{
			name:    "sds_bootstrap.repo",
			modTime: time.Date(2019, 3, 8, 22, 3, 20, 858474241, time.UTC),
